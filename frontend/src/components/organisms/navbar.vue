    ...
    <nav
        ...
        <div class="mb-2 sm:mb-0 flex items-center justify-center md:justify-start w-full md:w-auto">
            <router-link to="/" class="flex items-center justify-center md:justify-start">
                ...
                <span class="text-2xl font-semibold whitespace-nowrap text-cl5 font-[Taiko] text-center md:text-left">Elara Global Taiko Server</span>
            </router-link>
        </div>
        <div
            ...
            <a href="http://egts.ca:5000/" class="block py-2 px-3 text-cl5 rounded font-[Roboto] md:text-2xl sm:text-xl md:bg-transparent md:p-0 hover:text-cl6 mx-auto md:mx-0">LegacyWebUI</a>
...
<!--            <NavItem title="Leaderboard" to="/leaderboard"/>-->
            ...
            <NavItem v-if="authStore.isAuthenticated" title="Dashboard" to="/dashboard/profile"/>
        </div>
    </nav>
</template>
